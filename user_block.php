            ...
            <tr>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    ...
                    <td>
                        ...
                        <a href="ban.php?id=<?php echo $row['id']; ?>" style=""> <input type="button" id="delete" class="btn btn-primary rounded-pill py-2 btn-block" style="background-color: red;color: white;margin:0px  10px;" value="Block"></a></td>
